...
const en: Strings = {
  ...
  resetSentBody: 'If there is an account for that address, a link to choose a new password is on its way. It works once, and only for a limited time.',
  resetBack: 'Back to sign in',
  resetLinkExpired: 'That link did not work. It may have expired or been used already. Ask for a new one below.',
...
const ar: Strings = {
  ...
  resetSentBody: 'إن كان هناك حساب بهذا العنوان، فرابط اختيار كلمة مرور جديدة في طريقه إليك. يعمل الرابط مرة واحدة ولمدة محدودة.',
  resetBack: 'العودة إلى تسجيل الدخول',
  resetLinkExpired: 'لم ينجح هذا الرابط. ربما انتهت صلاحيته أو سبق استخدامه. اطلب رابطًا جديدًا أدناه.',
