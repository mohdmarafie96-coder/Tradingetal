...
const CONTENT_DIR = path.join(ROOT, 'src/course/content');
...
const MODULES = [
  ...
  { id: 'm01', dir: 'modules/01-market-foundations', time: { en: '3h', ar: '3 ساعات' }, title: { en: 'Market Foundations', ar: 'أسس الأسواق' }, lessons: ['01-how-prices-form.md', '02-bid-ask-spread.md', '03-liquidity-and-participants.md', '04-asset-classes.md'], quiz: true },
  { id: 'm02', dir: 'modules/02-what-is-a-cfd', time: { en: '4h', ar: '4 ساعات' }, title: { en: 'What a CFD Actually Is', ar: 'ما هو عقد الفروقات حقًّا' }, lessons: ['01-the-contract.md', '02-vs-owning.md', '03-long-and-short.md', '04-regulation.md'], quiz: true },
  { id: 'm03', dir: 'modules/03-contract-mechanics', time: { en: '5h', ar: '5 ساعات' }, title: { en: 'Contract Mechanics', ar: 'آليات العقد' }, lessons: ['01-contract-size.md', '02-pip-value.md', '03-calculating-pnl.md', '04-costs.md'], quiz: true },
  { id: 'm04', dir: 'modules/04-leverage-and-margin', time: { en: '5h', ar: '5 ساعات' }, title: { en: 'Leverage and Margin', ar: 'الرافعة المالية والهامش' }, lessons: ['01-leverage.md', '02-margin-mechanics.md', '03-margin-call.md', '04-gap-risk.md'], quiz: true },
  { id: 'm05', dir: 'modules/05-orders-and-execution', time: { en: '4h', ar: '4 ساعات' }, title: { en: 'Orders and Execution', ar: 'الأوامر والتنفيذ' }, lessons: ['01-order-types.md', '02-stops-and-targets.md', '03-execution-quality.md', '04-position-management.md'], quiz: true },
  { id: 'm06', dir: 'modules/06-risk-management', time: { en: '6h', ar: '6 ساعات' }, title: { en: 'Risk Management', ar: 'إدارة المخاطر' }, lessons: ['01-position-sizing.md', '02-expectancy.md', '03-drawdown.md', '04-correlation.md'], quiz: true },
  { id: 'm07', dir: 'modules/07-market-analysis', time: { en: '5h', ar: '5 ساعات' }, title: { en: 'Market Analysis', ar: 'تحليل السوق' }, lessons: ['01-reading-charts.md', '02-market-structure.md', '03-indicators.md', '04-fundamentals.md'], quiz: true },
  { id: 'm08', dir: 'modules/08-trading-plan', time: { en: '5h', ar: '5 ساعات' }, title: { en: 'Building a Trading Plan', ar: 'بناء خطة تداول' }, lessons: ['01-edge.md', '02-writing-the-plan.md', '03-journaling.md', '04-testing.md'], quiz: true },
  { id: 'm09', dir: 'modules/09-trading-psychology', time: { en: '3h', ar: '3 ساعات' }, title: { en: 'Trading Psychology', ar: 'سيكولوجيا التداول' }, lessons: ['01-biases.md', '02-tilt.md', '03-discipline.md'], quiz: true },
  { id: 'm10', dir: 'modules/10-operations', time: { en: '4h', ar: '4 ساعات' }, title: { en: 'Operations', ar: 'الجوانب التشغيلية' }, lessons: ['01-choosing-a-broker.md', '02-platform-and-specs.md', '03-records-and-tax.md', '04-scams.md'], quiz: true },
  { id: 'm11', dir: 'modules/11-capstone', time: { en: '8h+', ar: '8 ساعات+' }, title: { en: 'Capstone', ar: 'المشروع الختامي' }, lessons: ['01-programme.md', '02-assessment.md', '03-decision.md'], quiz: false },
];
